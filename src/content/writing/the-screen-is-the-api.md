...
<div class="panel-head"><span class="fig-no">FIG. 1</span><span class="fig-title">How the pieces fit</span></div>
<div class="panel-sub">one process tree on the phone · the agent is the same binary that runs in your terminal</div>
<svg class="flow" viewBox="0 0 848 300" role="img" aria-label="Telegram talks to the agent binary, which drives asterctl, which talks to the accessibility service, which reads and touches the phone">
<defs>
<pattern id="fig-dots" width="6" height="6" patternUnits="userSpaceOnUse">
<circle cx="1" cy="1" r="0.7" fill="var(--fig-hair)"/>
</pattern>
<pattern id="fig-dots-a" width="6" height="6" patternUnits="userSpaceOnUse">
<circle cx="1" cy="1" r="0.7" fill="var(--fig-accent)" opacity="0.35"/>
</pattern>
</defs>
<rect class="group" x="8" y="8" width="832" height="284" rx="10"/>
<text class="g-title" x="26" y="34">the phone · dev.aster.probe</text>
<rect class="node" x="40" y="58" width="180" height="58" rx="8"/>
<text class="n-name" x="130" y="84" text-anchor="middle">Telegram</text>
<text class="n-sub" x="130" y="101" text-anchor="middle">the person is elsewhere</text>
<rect class="node-a" x="300" y="58" width="220" height="58" rx="8"/>
<text class="n-name-a" x="410" y="84" text-anchor="middle">libaster.so</text>
<text class="n-sub" x="410" y="101" text-anchor="middle">AsterAgentService · yolo mode</text>
<rect class="node" x="600" y="58" width="200" height="58" rx="8"/>
<text class="n-name" x="700" y="84" text-anchor="middle">asterctl</text>
<text class="n-sub" x="700" y="101" text-anchor="middle">the agent's body</text>
<rect class="node" x="300" y="176" width="220" height="58" rx="8"/>
<text class="n-name" x="410" y="202" text-anchor="middle">AsterA11yService</text>
<text class="n-sub" x="410" y="219" text-anchor="middle">reads the tree, dispatches touches</text>
<rect class="node" x="600" y="176" width="200" height="58" rx="8"/>
<text class="n-name" x="700" y="202" text-anchor="middle">the phone itself</text>
<text class="n-sub" x="700" y="219" text-anchor="middle">apps, settings, notifications</text>
<path class="edge" d="M220 87 H300"/>
<path class="edge" d="M520 87 H600"/>
<path class="edge" d="M700 116 V176"/>
<path class="edge" d="M600 205 H520"/>
<path class="edge-a" d="M410 116 V176"/>
<text class="e-label" x="260" y="80" text-anchor="middle">chat</text>
<text class="e-label" x="560" y="80" text-anchor="middle">run_command</text>
<text class="e-label" x="712" y="150">abstract socket</text>
<text class="e-label" x="560" y="198" text-anchor="middle">@aster-eyes</text>
<text class="e-label-a" x="422" y="150">exec</text>
</svg>
</div>
<figcaption class="cap"><b>Figure 1.</b> The agent is not a reimplementation. It is the release binary from this workspace, cross-compiled for <code>aarch64-linux-android</code> and shipped inside the APK as <code>libaster.so</code>. Everything above the socket is the same code that runs in a terminal.</figcaption>
</figure>
...
The first version of this was a measuring rig. `docs/COMPUTER-USE.md` is the macOS-first plan for Aster's computer use, and the questions it leaves open there, how fast a UI tree read is, whether an action can be confirmed, are the same questions a phone asks with fewer places to hide. The honest way to answer them was to build the thing and measure it. It turned out to be useful enough that it is now the daily-driver way to run Aster on a phone.
...
<figure>
<div class="figure-panel">
<div class="panel-head"><span class="fig-no">FIG. 2</span><span class="fig-title">What one screen read costs</span></div>
<div class="panel-sub">milliseconds, log scale · the same screen, five conditions</div>
<svg class="flow" viewBox="0 0 848 300" role="img" aria-label="Log-scale bar chart of screen read latency: 8 milliseconds with the screen still, 21 at the fling median, 84 at the fling 95th percentile, 100 to 600 across an app launch, and 2,470 for adb uiautomator dump, which is 300 times the still-screen read">
<line class="grid" x1="150" y1="44" x2="150" y2="244"/>
<line class="grid" x1="317.5" y1="44" x2="317.5" y2="244"/>
<line class="grid" x1="485" y1="44" x2="485" y2="244"/>
<line class="grid" x1="652.5" y1="44" x2="652.5" y2="244"/>
<line class="grid" x1="820" y1="44" x2="820" y2="244"/>
<text class="axis" x="150" y="258" text-anchor="middle">1</text>
<text class="axis" x="317.5" y="258" text-anchor="middle">10</text>
<text class="axis" x="485" y="258" text-anchor="middle">100</text>
<text class="axis" x="652.5" y="258" text-anchor="middle">1,000</text>
<text class="axis" x="820" y="258" text-anchor="end">10,000 ms</text>
<text class="n-name" x="140" y="86" text-anchor="end">screen still</text>
<rect class="bar" x="150" y="72" width="151" height="20" rx="2"/>
<text class="v-label" x="322" y="86">8 ms</text>
<text class="n-name" x="140" y="122" text-anchor="end">fling, p50</text>
<rect class="bar" x="150" y="108" width="221" height="20" rx="2"/>
<text class="v-label" x="379" y="122">21 ms</text>
<text class="n-name" x="140" y="158" text-anchor="end">fling, p95</text>
<rect class="bar" x="150" y="144" width="322" height="20" rx="2"/>
<text class="v-label" x="490" y="158">84 ms</text>
<text class="n-name" x="140" y="194" text-anchor="end">app launch</text>
<rect class="bar-range" x="485" y="180" width="130" height="20" rx="2"/>
<text class="v-label" x="623" y="194">100 to 600 ms</text>
<text class="n-name-a" x="140" y="230" text-anchor="end">uiautomator dump</text>
<rect class="bar-a" x="150" y="216" width="568" height="20" rx="2"/>
<text class="v-label-a" x="726" y="230">2,470 ms</text>
<path class="bracket" d="M301 52 H718 M718 52 V226"/>
<text class="bracket-label" x="509" y="44" text-anchor="middle">300×</text>
</svg>
</div>
<figcaption class="cap"><b>Figure 2.</b> The same screen read five ways. The axis is logarithmic, so each gridline is ten times the last; the bars are the shape of the decision, not a linear comparison. Reading in-process is fast enough to do after every action. <code>uiautomator dump</code> is not, and that is the whole reason the accessibility service exists.</figcaption>
</figure>
...
<div class="statrow">
<div class="stat"><div class="v">1080p60</div><div class="l">hardware H.264, top setting</div></div>
<div class="stat"><div class="v">30 s</div><div class="l">the consent window it answers in</div></div>
<div class="stat"><div class="v">333 ms</div><div class="l">the system's still-frame floor</div></div>
<div class="stat"><div class="v">30 min</div><div class="l">one capture outlives its viewers</div></div>
</div>
...
Some of those files the agent writes itself, which is the next section.
...
<div class="statrow">
<div class="stat"><div class="v">6 calls</div><div class="l">the floor for a turn worth learning</div></div>
<div class="stat"><div class="v">180 s</div><div class="l">the reflection's timeout</div></div>
<div class="stat"><div class="v">1,500</div><div class="l">words the skill body is capped at</div></div>
<div class="stat"><div class="v">2</div><div class="l">facts it may add to memory</div></div>
</div>
...
I write about this because it is what I do all day: build the harness around the model, not the model itself. The phone is just the version of that problem with the fewest places to hide.

I am looking for my next role, AI DevRel Engineer or AI Engineering. If your team works on agents, developer tools, or anything where the hard part is making a model reliable in a place it was not designed for, I want to talk. Reach me at [chiziaruhoma@gmail.com](mailto:chiziaruhoma@gmail.com).
